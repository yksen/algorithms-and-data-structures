...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[dashed] (1) -- node[e] {8} (2);
        \draw[dashed] (5) -- node[e] {12} (6);
        \draw[dashed] (3) -- node[e] {15} (4);
        \draw[dashed] (2) -- node[e] {20} (6);
    \end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    \begin{tikzpicture}
        ...
        \node[v, label=-90:(4)] (4) [below of=3] {4};
        ...
        \draw[dashed, Latex-] (6) -- node[e] {4} (7);
